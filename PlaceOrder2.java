...
//        oId=String.valueOf(order.orderId);
//        String price=getIntent().getStringExtra(order.INTENT_ORDER_PRICE);
//        order.orderAmount=getIntent().getIntExtra(order.INTENT_ORDER_PRICE,0);
//        gigTitle=getIntent().getStringExtra("gig_title");
//        order.freelancerUsername=getIntent().getStringExtra("f_username");
//        order.paymentStatus=getIntent().getStringExtra(order.INTENT_ORDER_PAYMENT_STATUS);
//        order.orderStatus=getIntent().getStringExtra(order.INTENT_ORDER_STATUS);



        //gId=getIntent().getIntExtra(gig.INTENT_GIG_ID,0);

//        if(order.orderStatus.equals("Accepted") && (order.paymentStatus.equals("pending"))){
